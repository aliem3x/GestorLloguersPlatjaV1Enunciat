        ...
        if(hmc.isLlogat()==false){
            do{ 
                if(i<4){
                    ...
                    System.out.println("No es poden afegir més de 4 Hamaques");
                    trobat=true;
                }
            }while(!trobat);
        }
        else{
            System.out.println("La hamaca seleccionada ja està en lloguer");
            trobat=true;
        }
    }
        ...
        if(hmc.isLlogat()==true){
            do{
                if(i<4){
                    ...
                    System.out.println("La amaca que vol treure no pertany a aquesta Ombrella");
                    trobat=true;
                }
            }while(!trobat);
        }
        else{
            System.out.println("La hamaca seleccionada no s'està llogant");
            trobat=true;
        }
        hamaques[i] = null;
    }
