...
public class Aplicacio {
    ...
    //Afegir elements zona si aquets no estan afegits. Mètodes seleccionar de la classe
    //zona.
        ...
        do {
            ...
            switch (opcio) {
                case 0:
                    break;
                case 1:
                    posVelomar = platjaActual.seleccionarVelomar();
                    if (posVelomar < 0) {
                ...
                case 3:
                     posVelomar = platjaActual.seleccionarVelomar();
                    if (posVelomar >= 0) {
                        platjaActual.getVelomars()[posVelomar].modificarVelomar();
                    }
                    else{
                        System.out.println("\nEl Velomar no está donat d'alta a aquesta platja");
                        }                    
                    break;
                case 4:
        ...
        do {
            ...
            switch (opcio) {
                case 0:
                    break;
                case 1:
                    posOmbrella = platjaActual.seleccionarOmbrella();
                    if (posOmbrella < 0) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                     posOmbrella = platjaActual.seleccionarHamaca();
                    if (posOmbrella >= 0) {
                        platjaActual.getOmbrelles()[posOmbrella].modificarOmbrella();
                    }
                    else{
                        System.out.println("\nLa Ombrella no está donada d'alta a aquesta platja");
                        }                    
                    break;
                case 4:
        ...
        do {
            ...
            switch (opcio) {
                case 0:
                    break;
                case 1:
                    posHamaques = platjaActual.seleccionarHamaca();
                    if (posHamaques  < 0) {
                ...
                case 3:
                     posHamaques = platjaActual.seleccionarHamaca();
                    if (posHamaques >= 0) {
                        platjaActual.getHamaques()[posHamaques].modificarHamaca();
                    }
                    else{
                        System.out.println("\nLa Hamaca no está donada d'alta a aquesta platja");
                        }                    
                    break;
                case 4:
    ...
    public static void menuEncarregats() {
       int opcio = 0;
        ...
        do {
            ...
            System.out.println("\n2. Baixa");
            System.out.println("\n3. Modificar");
            System.out.println("\n4. LListar encarregats");
            opcio = dades.nextInt();
            switch (opcio) {
                case 0:
                    break;
                case 1:
                    posEncarregat = platjaActual.seleccionarEncarregat();
                    if (posEncarregat < 0) {
                        platjaActual.afegirEncarregat();
                    } else {
                        System.out.println("\nJa existeix");
                    }
                    break;
                ...
                case 3:
                     posEncarregat = platjaActual.seleccionarEncarregat();
                    if (posEncarregat >= 0) {
                        platjaActual.getEncarregats()[posEncarregat].modificarEncarregat();
                    }
                    else{
                        System.out.println("\nEl Encarregat no está donat d'alta a aquesta platja");
                        }                    
                    break;
                case 4:
